...
Item {
    ...
    property string __internalBlurVertexShader: "qrc:/fastblur_internal.vert.qsb"
    property string __internalBlurFragmentShader: "qrc:/fastblur_internal.frag.qsb"

    ShaderEffect {
        id: level0
        //property variant source: sourceProxy.output
        property var source: rootItem.source
    ...
    ShaderEffect {
        ...
        fragmentShader: "qrc:/fastblur.frag.qsb"
    }
}
